...
int green_complex_calc_int(const double r, const double theta, const double phi,
                           complex double *X, complex double *Y, complex double *Z,
                           green_complex_workspace *w);
int green_complex_calc_ext(const double r, const double theta, const double phi,
                           complex double *X, complex double *Y, complex double *Z,
                           green_complex_workspace *w);
