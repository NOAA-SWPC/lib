...
set ylabel "dX (nT)"
plot '../output/data2_DX_EW.dat' us 5:($7-$8) every nskip w dot
unset title

load 'incrow.cfg'

set ylabel "dY (nT)"
plot '../output/data2_DY_EW.dat' us 5:($7-$8) every nskip w dot

load 'incrow.cfg'

set xlabel "QD latitude (degrees)"
set ylabel "dZ (nT)"
plot '../output/data2_DZ_EW.dat' us 5:($7-$8) every nskip w dot
