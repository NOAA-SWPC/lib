...
c          jf(31)=.false.     ! t=B0ABT f=Gulyaeva
          jf(33)=.false. 	  ! f=auroral boundary off
...
8193  FORMAT(/'-'/1X,A5,' ELECTRON DENSITY   TEMPERATURES ',
     &  4X,'ION PERCENTAGES[%]*10',3X,'1E16m-2'/2X,A4,' Ne/cm-3 Ne/NmF2',
     &  ' Tn/K  Ti/K  Te/K  O+  N+  H+ He+ O2+ NO+ Clust TEC t/%')
9193  FORMAT(/'-'/1X,A5,' ELECTRON DENSITY   TEMPERATURES ',
     &  8X,'ION DENS.[m-3]/1E9',2x,'1E16m-2'/2X,A4,' Ne/cm-3 Ne/NmF2',
     &  ' Tn/K  Ti/K  Te/K  O+  N+  H+ He+ O2+ NO+ Clust TEC t/%')
...
c
        ...
        jino=INT(OUTF(8,li)*scid+.5)
        jio2=INT(OUTF(9,li)*scid+.5)
