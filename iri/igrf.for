...
c
        ...
        CALL MYFELDG(LATI,LONGI,HEIGHT,BNORTH,BEAST,BDOWN,BABS)
...
c
		...
		h = height
        CALL FELDCOF(YEAR,DIMO)
        CALL MYFELDG(XLATI,XLONGI,H,BNORTH,BEAST,BDOWN,BABS)
...
C
C
      SUBROUTINE MYFELDG(GLAT,GLON,ALT,BNORTH,BEAST,BDOWN,BABS)           
c-----------------------------------------------------------------------        
