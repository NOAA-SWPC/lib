...
set title "Using Star Camera Quaternions"
set yrange [-200:200]

set ylabel "{/Symbol \104}{/Symbol \141} (arcseconds)"
plot 'euler.dat.A.q' us 1:5 w li ls 1 ti "A", \
     'euler.dat.B.q' us 1:5 w li ls 2 ti "B", \
     'euler.dat.C.q' us 1:5 w li ls 3 ti "C"
...
plot 'euler.dat.A.q' us 1:6 w li ls 1 ti "A", \
     'euler.dat.B.q' us 1:6 w li ls 2 ti "B", \
     'euler.dat.C.q' us 1:6 w li ls 3 ti "C"
...
plot 'euler.dat.A.q' us 1:7 w li ls 1 ti "A", \
     'euler.dat.B.q' us 1:7 w li ls 2 ti "B", \
     'euler.dat.C.q' us 1:7 w li ls 3 ti "C"

unset key
unset xlabel

set title "Spacecraft-fixed basis"
...
set ylabel "{/Symbol \104}{/Symbol \141} (arcseconds)"
plot 'euler.dat.A.s' us 1:5 w li ls 1 ti "A", \
     'euler.dat.B.s' us 1:5 w li ls 2 ti "B", \
     'euler.dat.C.s' us 1:5 w li ls 3 ti "C"
...
set ylabel "{/Symbol \104}{/Symbol \142} (arcseconds)"
plot 'euler.dat.A.s' us 1:6 w li ls 1 ti "A", \
     'euler.dat.B.s' us 1:6 w li ls 2 ti "B", \
     'euler.dat.C.s' us 1:6 w li ls 3 ti "C"
...
set ylabel "{/Symbol \104}{/Symbol \147} (arcseconds)"
plot 'euler.dat.A.s' us 1:7 w li ls 1 ti "A", \
     'euler.dat.B.s' us 1:7 w li ls 2 ti "B", \
     'euler.dat.C.s' us 1:7 w li ls 3 ti "C"
